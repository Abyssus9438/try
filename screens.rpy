...
screen notebook():
  ...
  button:
    ...
    background"images/book1.png"

    selected_background"images/book1.png"

    selected category=="book1"

    hover_background im.MatrixColor("images/book1.png",

      im.matrix.brightness(0.3))

    xysize(110,83)

    action SetScreenVariable('category','book1')

  if category == "book1":

    frame:

      background"images/xin1.png"
